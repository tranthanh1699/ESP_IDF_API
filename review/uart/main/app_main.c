...
void uart_0_callback(intr_message_t rx_message)
{
	esp32_uart_log(EX_UART_NUM, "Into callback, uart length: %d\n", rx_message.uart_length); 
	esp32_uart_log(UART_NUM_0, "Receiver Callback: %s\n", rx_message.message); 
}
